...
public class CourseController {
    ...
    @GetMapping
    public ResponseEntity<Page<ResponseCoursePage>> getCoursePage(CourseSearchCondition courseSearchCondition, Pageable pageable) {
    ...
    @PostMapping
    public ResponseEntity<Long> createCourse(@ModelAttribute RequestCreateCourse requestCreateCourse){
        return ResponseEntity.status(HttpStatus.CREATED).body(courseService.createCourse(requestCreateCourse));
    }
    ...
    public ResponseEntity<Long> updateCourseById(@PathVariable("course-id") Long courseId,
                                                 @ModelAttribute RequestUpdateCourse requestUpdateCourse) {
        return ResponseEntity.status(HttpStatus.OK).body(courseService.updateCourseById(courseId, requestUpdateCourse));
    }
